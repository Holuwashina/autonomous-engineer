---
name: cceo-workflow-patterns
description: The six adaptive workflow patterns the Engineering Director composes when driving a CCEO run. Use this to decide which patterns fit a ticket, and how to compose them.
---

# CCEO Workflow Patterns
...
### Default pipelines (described in detail in `cceo-bug-workflow` and `cceo-feature-workflow`)
